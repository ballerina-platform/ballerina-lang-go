...
func walkDirectCallArgs(cx *functionContext, expr invocable, fnSym model.FunctionSymbol) []ast.BLangStatement {
	sig := fnSym.Signature()
...
func fillNewExprInitDefaults(cx *functionContext, expr *ast.BLangNewExpression) []ast.BLangStatement {
...
func createOperandTempVar(cx *functionContext, ty semtypes.SemType, initExpr ast.BLangExpression, pos diagnostics.Location, initStmts []ast.BLangStatement) (*ast.BLangIdentifier, model.SymbolRef, []ast.BLangStatement) {
...
func createNilResultVar(cx *functionContext, ty semtypes.SemType, pos diagnostics.Location, initStmts []ast.BLangStatement) (*ast.BLangIdentifier, model.SymbolRef, []ast.BLangStatement) {
