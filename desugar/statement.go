...
func walkBlockFunctionBody(cx *functionContext, body *ast.BLangBlockFunctionBody) desugaredNode[ast.StatementNode] {
	...
	body.Stmts = allStmts
	return desugaredNode[ast.StatementNode]{replacementNode: body}
}
