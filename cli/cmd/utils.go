...
// nativePal is the native-CLI implementation of pal.Platform passed into
// runtime.NewRuntime. The HTTP factory and its TLS plumbing live in
// native_http.go; IO is small enough to inline here.
