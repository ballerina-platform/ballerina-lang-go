...
func execInstruction(inst bir.BIRNonTerminator, frame *Frame) {
	...
	case bir.INSTRUCTION_KIND_NEW_STRUCTURE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_STRUCTURE")
	case bir.INSTRUCTION_KIND_MAP_STORE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_MAP_STORE")
	case bir.INSTRUCTION_KIND_MAP_LOAD:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_MAP_LOAD")
	case bir.INSTRUCTION_KIND_NEW_ARRAY:
		execNewArray(inst.(*bir.NewArray), frame)
	case bir.INSTRUCTION_KIND_ARRAY_STORE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_ARRAY_STORE")
	case bir.INSTRUCTION_KIND_ARRAY_LOAD:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_ARRAY_LOAD")
	case bir.INSTRUCTION_KIND_NEW_ERROR:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_ERROR")
	case bir.INSTRUCTION_KIND_TYPE_CAST:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_TYPE_CAST")
	case bir.INSTRUCTION_KIND_IS_LIKE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_IS_LIKE")
	case bir.INSTRUCTION_KIND_TYPE_TEST:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_TYPE_TEST")
	case bir.INSTRUCTION_KIND_NEW_INSTANCE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_INSTANCE")
	case bir.INSTRUCTION_KIND_OBJECT_STORE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_OBJECT_STORE")
	case bir.INSTRUCTION_KIND_OBJECT_LOAD:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_OBJECT_LOAD")
	case bir.INSTRUCTION_KIND_PANIC:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_PANIC")
	case bir.INSTRUCTION_KIND_FP_LOAD:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_FP_LOAD")
	case bir.INSTRUCTION_KIND_STRING_LOAD:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_STRING_LOAD")
	case bir.INSTRUCTION_KIND_NEW_XML_ELEMENT:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_XML_ELEMENT")
	case bir.INSTRUCTION_KIND_NEW_XML_TEXT:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_XML_TEXT")
	case bir.INSTRUCTION_KIND_NEW_XML_COMMENT:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_XML_COMMENT")
	case bir.INSTRUCTION_KIND_NEW_XML_PI:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_XML_PI")
	case bir.INSTRUCTION_KIND_NEW_XML_SEQUENCE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_XML_SEQUENCE")
	case bir.INSTRUCTION_KIND_NEW_XML_QNAME:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_XML_QNAME")
	case bir.INSTRUCTION_KIND_NEW_STRING_XML_QNAME:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_STRING_XML_QNAME")
	case bir.INSTRUCTION_KIND_XML_SEQ_STORE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_XML_SEQ_STORE")
	case bir.INSTRUCTION_KIND_XML_SEQ_LOAD:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_XML_SEQ_LOAD")
	case bir.INSTRUCTION_KIND_XML_LOAD:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_XML_LOAD")
	case bir.INSTRUCTION_KIND_XML_LOAD_ALL:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_XML_LOAD_ALL")
	case bir.INSTRUCTION_KIND_XML_ATTRIBUTE_LOAD:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_XML_ATTRIBUTE_LOAD")
	case bir.INSTRUCTION_KIND_XML_ATTRIBUTE_STORE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_XML_ATTRIBUTE_STORE")
	case bir.INSTRUCTION_KIND_NEW_TABLE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_TABLE")
	case bir.INSTRUCTION_KIND_NEW_TYPEDESC:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_TYPEDESC")
	case bir.INSTRUCTION_KIND_NEW_STREAM:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_STREAM")
	case bir.INSTRUCTION_KIND_TABLE_STORE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_TABLE_STORE")
	case bir.INSTRUCTION_KIND_TABLE_LOAD:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_TABLE_LOAD")
	...
	case bir.INSTRUCTION_KIND_NEW_REG_EXP:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_REG_EXP")
	case bir.INSTRUCTION_KIND_NEW_RE_DISJUNCTION:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_DISJUNCTION")
	case bir.INSTRUCTION_KIND_NEW_RE_SEQUENCE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_SEQUENCE")
	case bir.INSTRUCTION_KIND_NEW_RE_ASSERTION:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_ASSERTION")
	case bir.INSTRUCTION_KIND_NEW_RE_ATOM_QUANTIFIER:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_ATOM_QUANTIFIER")
	case bir.INSTRUCTION_KIND_NEW_RE_LITERAL_CHAR_ESCAPE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_LITERAL_CHAR_ESCAPE")
	case bir.INSTRUCTION_KIND_NEW_RE_CHAR_CLASS:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_CHAR_CLASS")
	case bir.INSTRUCTION_KIND_NEW_RE_CHAR_SET:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_CHAR_SET")
	case bir.INSTRUCTION_KIND_NEW_RE_CHAR_SET_RANGE:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_CHAR_SET_RANGE")
	case bir.INSTRUCTION_KIND_NEW_RE_CAPTURING_GROUP:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_CAPTURING_GROUP")
	case bir.INSTRUCTION_KIND_NEW_RE_FLAG_EXPR:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_FLAG_EXPR")
	case bir.INSTRUCTION_KIND_NEW_RE_FLAG_ON_OFF:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_FLAG_ON_OFF")
	case bir.INSTRUCTION_KIND_NEW_RE_QUANTIFIER:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_NEW_RE_QUANTIFIER")
	case bir.INSTRUCTION_KIND_RECORD_DEFAULT_FP_LOAD:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_RECORD_DEFAULT_FP_LOAD")
	case bir.INSTRUCTION_KIND_PLATFORM:
		fmt.Println("NOT IMPLEMENTED: INSTRUCTION_KIND_PLATFORM")
	default:
