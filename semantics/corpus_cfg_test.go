...
var cfgGenerationSkipList = []string{
	...
	"subset8/08-bug/map1-v.bal",
	"subset8/08-bug/map2-v.bal",
	"subset8/08-bug/map3-v.bal",
	"subset8/08-bug/map5-v.bal",
	"subset8/08-bug/map6-v.bal",
	"subset8/08-bug/whilenarrow1-v.bal",
	"subset8/08-inclusive/compoundassign1-v.bal",
	"subset8/08-inclusive/construct1-v.bal",
	"subset8/08-inclusive/construct2-v.bal",
	"subset8/08-inclusive/construct3-v.bal",
	"subset8/08-inclusive/construct6-v.bal",
	"subset8/08-inclusive/fieldexpr1-v.bal",
	"subset8/08-inclusive/fieldexpr4-v.bal",
	"subset8/08-inclusive/fieldexpr5-v.bal",
	"subset8/08-inclusive/fieldexpr6-v.bal",
	"subset8/08-inclusive/fieldexpr7-v.bal",
	"subset8/08-inclusive/fieldexpr8-v.bal",
	"subset8/08-inclusive/fieldlvalue1-v.bal",
	"subset8/08-inclusive/fieldlvalue3-v.bal",
	"subset8/08-inclusive/fieldlvalue4-v.bal",
	"subset8/08-inclusive/fieldlvalue7-v.bal",
	"subset8/08-inclusive/fieldlvalue8-v.bal",
	"subset8/08-inclusive/inherent1-p.bal",
	"subset8/08-inclusive/inherent2-v.bal",
	"subset8/08-inclusive/inline1-v.bal",
	"subset8/08-inclusive/inline2-v.bal",
	"subset8/08-inclusive/typetest1-v.bal",
	"subset8/08-infinite/infiniteRecord-v.bal",
	"subset8/08-intersect/mapping2-v.bal",
	"subset8/08-list/18-v.bal",
	"subset8/08-map/9-v.bal",
	"subset8/08-map/boolean-v.bal",
	"subset8/08-map/equal-v.bal",
	"subset8/08-map/float1-v.bal",
	"subset8/08-map/int3-v.bal",
	"subset8/08-map/int8-v.bal",
	"subset8/08-mapping/1-v.bal",
	"subset8/08-mapping/10-v.bal",
	"subset8/08-mapping/13-v.bal",
	"subset8/08-mapping/2-v.bal",
	"subset8/08-mutate/mappingif1-v.bal",
	"subset8/08-mutate/mappingif2-v.bal",
	"subset8/08-mutate/mappingif3-v.bal",
	"subset8/08-narrowing/if7-v.bal",
	"subset8/08-narrowing/if9-v.bal",
	"subset8/08-narrowing/while1-v.bal",
	"subset8/08-nested/bdd1-v.bal",
	"subset8/08-nested/eqcycle1-v.bal",
	"subset8/08-nested/exact2-p.bal",
	"subset8/08-nested/exact3-v.bal",
	"subset8/08-nested/exact5-p.bal",
	"subset8/08-nested/exact6-p.bal",
	"subset8/08-nested/fieldlvalue1-v.bal",
	"subset8/08-nested/fieldlvalue2-v.bal",
	"subset8/08-nested/fieldlvalue3-v.bal",
	"subset8/08-nested/fieldlvalue4-v.bal",
	"subset8/08-nested/json1-v.bal",
	"subset8/08-nested/proj2-v.bal",
	"subset8/08-nested/record1-v.bal",
	"subset8/08-nested/record2-v.bal",
	"subset8/08-nested/semtype1-v.bal",
	"subset8/08-singleton/exact1-v.bal",
	"subset8/08-singleton/proj1-v.bal",
	"subset8/08-singleton/proj3-v.bal",
	"subset8/08-singleton/proj5-v.bal",
	"subset8/08-typecast/2-v.bal",
	"subset8/08-union/construct1-v.bal",
	"subset8/08-union/construct5-v.bal",
