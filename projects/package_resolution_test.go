...
func TestPackageResolution_TransitiveDependency(t *testing.T) {
	...
	// (lang.int, lang.error, lang.string, lang.value, lang.xml), giving 9
	// packages total in the cache.
	assert.Equal(9, env.PackageCache().Size(), "expected 9 packages in cache after compilation")
